...
Scope: local operator + BYO-JSONL experimenter. No remote sensors. No actuators.
...
| Train packs | Low — public for local bake-off |

## Actors

1. **Local operator (author)** — trusted to run sealed eval once; peek at held-out key = conscious cheat.
